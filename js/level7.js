var level7State = {
  ...
  create: function() {
    ...
    zombieT.scale.setTo(3, 3);

    door7 = game.add.sprite(717, 265, 'door');
    ...
    game.physics.arcade.enable(door7);
  ...
  update: function() {
    ...
    game.physics.arcade.moveToObject(zombieT, ed, 100)
    ...
    game.physics.arcade.collide(ed, door7, () => {
