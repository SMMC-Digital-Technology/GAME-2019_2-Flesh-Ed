var level5State = {
  ...
  create: function() {
    ...
    door5 = game.add.sprite(717, 265, 'door');
    ...
    game.physics.arcade.enable(door5);
  ...
  update: function() {
    ...
    game.physics.arcade.moveToObject(zombieT, ed, 80)
    game.physics.arcade.moveToObject(zombieS, ed, 80)
    game.physics.arcade.moveToObject(zombieTT, ed, 80)
    game.physics.arcade.moveToObject(zombieSS, ed, 80)
    ...
    game.physics.arcade.collide(ed, door5, () => {
