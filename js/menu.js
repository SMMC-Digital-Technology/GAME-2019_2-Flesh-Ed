...
var menuState = {
   create: function() {
      ...
      //  if(space.isDown) {
        ...
        title = game.add.text(game.world.centerX, game.world.centerY-100, 'Flesh Ed', {font: '50px Arial', fill: '#C70039'});
        ...
        instructions = game.add.text(80, game.world.height-80, 'Hit space if you think you are ready!', {font: '25px Arial', fill: '#ffffff'});
